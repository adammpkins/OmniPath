...
import (
	...
	"github.com/adammpkins/OmniPath/internal/dependency"

	"github.com/spf13/cobra"
)

var depdocsCmd = &cobra.Command{
	Use:   "depdocs",
	Short: "Open dependency documentation for the current project",
	Run: func(cmd *cobra.Command, args []string) {
		deps, err := dependency.DetectDependencies()
		if err != nil {
			log.Fatalf("Error detecting dependencies: %v", err)
		}

		var selected dependency.DependencyDocs
		if len(deps) == 1 {
			selected = deps[0]
		} else {
